...
# -contains the concatenated aa and dna sequences of sp1 'concatened_'+specie1'.fst'
# -contains the concatenated aa and dna sequences of sp1  concatened_'+specie2'.fst'
...
os.system('cat '+new_directory_sp1+'* > concatened_'+specie1+'.fst')
os.system('cat '+new_directory_sp2+'* > concatened_'+specie2+'.fst')

#------------------------------------
Dna_aa_1_species_concatened="concatened_"+specie1+'.fst'
Dna_aa_2_species_concatened="concatened_"+specie2+'.fst'
