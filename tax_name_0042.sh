#PBS -S /bin/bash
#PBS -l nodes=1:ppn=8
#PBS -e /pandata/bguinet/LEPIWASP/blast_database/tax_name_candidates_0042.error
#PBS -o /pandata/bguinet/LEPIWASP/blast_database/tax_name_candidates_0042.out
#PBS -q q1hour
#PBS -N tax_name_candidates_0042
...
diamond_tab_output=/pandata/bguinet/LEPIWASP/blast_database/matches_0042_candidates.m8  #Your output blast of your candidates genes 
...
$Diamond_blast_to_taxid -i $diamond_tab_output -t $taxid -c $categories -n $names -d $description -o /pandata/bguinet/LEPIWASP/blast_database/outfile_0042.tab
