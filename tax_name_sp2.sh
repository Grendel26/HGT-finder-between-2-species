#PBS -S /bin/bash
#PBS -l nodes=1:ppn=8
#PBS -e /pandata/bguinet/LEPIWASP/blast_database/tax_name_candidates_sp2.error
#PBS -o /pandata/bguinet/LEPIWASP/blast_database/tax_name_candidates_sp2.out
#PBS -q q1day
#PBS -N tax_name_candidates_sp2
...
diamond_tab_output=/pandata/bguinet/LEPIWASP/blast_database/matches_sp2_candidates.m8  #Your output blast of your candidates genes 
...
$Diamond_blast_to_taxid -i $diamond_tab_output -t $taxid -c $categories -n $names -d $description -o /pandata/bguinet/LEPIWASP/blast_database/outfile_sp2.tab
