...
diamond_tab_output=/pandata/bguinet/LEPIWASP/blast_database/matches_0035_candidates.m8  #Your output blast of your candidates genes 
...
$Diamond_blast_to_taxid -i $diamond_tab_output -t $taxid -c $categories -n $names -d $description -o /pandata/bguinet/LEPIWASP/blast_database/outfile_0035.tab
